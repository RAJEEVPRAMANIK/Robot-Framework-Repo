...
KW_5_1: Browser Add Cookie
    Add Cookie  foo     bar     domain=${SiteURL}

KW_5: Browser GET Cookie
    ${Get_Cookie}=  Get Cookie      foo
    log     The cookie are :  ${Get_Cookie}
